...
//Users can easily input the name of a city, and the app will fetch current weather data from a reliable API to provide up-to-date information on temperature, humidity, and weather conditions. The user-friendly interface allows people to quickly access the information they need. Additionally, the app includes a feature for sharing weather updates with friends, making it easy to keep others in the loop about the current weather in their area.
//This intuitive tool enabled me to build a visually appealing and highly functional site tailored to my client's specific needs. The website's design prioritises ease of navigation, ensuring users can find the information they seek without difficulty. By incorporating engaging elements and thoughtful layouts, the website delivers a seamless and enjoyable experience.
//The webpage was designed with a modern aesthetic to draw in the customer. Visitors can easily read customer reviews, using an api, to learn more about the company's reputation and product quality. We also integrated a user-friendly booking form, making it simple for potential customers to schedule a consultation with just a few clicks.
...
const cardData = [
  {
    ...
    text: "Weather Wizard is an innovative app built with TypeScript and React that offers a seamless way for users to stay informed about the weather in any city.",
    link: "/weather-page",
  },
  {
    id: 0,
